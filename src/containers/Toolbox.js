...
Toolbox.getDefaultToolBox = function (Msg) {
    var ret =
    '<xml id="toolbox-categories" style="display: none">' +
    '<category name="움직임" colour="#4C97FF" secondaryColour="#3373CC">' +
    ...
    '</category>' +
    '<category name="생김새" colour="#9966FF" secondaryColour="#774DCB">' +
    ...
    '</category>' +
    '<category name="소리" colour="#D65CD6" secondaryColour="#BD42BD">' +
    ...
    '</category>' +
    '<category name="펜" colour="#00B295" secondaryColour="#0B8E69">' +
    ...
    '</block>' +
    '</category>' +
    '<category name="데이터" colour="#FF8C1A" secondaryColour="#DB6E00" custom="VARIABLE">' +
    '</category>' +
    '<category name="리스트" colour="#FF8C1A" secondaryColour="#DB6E00">' +
    ...
    '</category>' +
    '<category name="시작" colour="#FFD500" secondaryColour="#CC9900">' +
    ...
    '</block>' +
    '</category>' +
    '<category name="흐름" colour="#FFAB19" secondaryColour="#CF8B17">' +
    ...
    '</category>' +
    '<category name="감지" colour="#4CBFE6" secondaryColour="#2E8EB8">' +
    ...
    '</category>' +
    '<category name="계산" colour="#40BF4A" secondaryColour="#389438">' +
